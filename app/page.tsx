...
export default function Home() {
  ...
  function submitBooking(event: FormEvent<HTMLFormElement>) {
    ...
    const body = encodeURIComponent(`Hello King Mozy Tours and Travel,\n\nI would like to plan a trip.\n\nName: ${data.get("name")}\nEmail / phone: ${data.get("contact")}\nTrip: ${data.get("trip")}\nTravel month: ${data.get("month")}\nGuests: ${data.get("guests")}\n\nNotes: ${data.get("notes") || "No additional notes"}`);
    window.location.href = `mailto:kingmozytoursandtravel@gmail.com?subject=${subject}&body=${body}`;
  }
